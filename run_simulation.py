...
def run_6_body_simulation(
    ...
    while t < t_end:
        ...
        if pair:
            ...
            print(f"Collision detected at {t.value_in(units.yr):.1f} yr between keys {key_i} and {key_j}")
            ...
            if success:
                ...
                if remnant is None:
                    ...
                    print(f"Destructive collision: simulation stopped at t = {t.value_in(units.yr):.1f} yr.")
                    break
...
def collision(key_i, key_j, n_collision, gravity, seba, key_map, t, run_label=""):
    ...
    try:
        ...
        print(f"Collision {n_collision} processed: remnant = {m_bound.value_in(units.MSun):.2f} M☉, "
